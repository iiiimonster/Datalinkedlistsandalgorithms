 ...
 */
public class LeetcodeNodeSinglyLinkedListOfLeadingNodes<T> {
    //长度
    private int size;
    //虚拟头节点
     ...
     * @param data 头节点数据
     */
    public LeetcodeNodeSinglyLinkedListOfLeadingNodes(T data) {
    ...
    public static void main(String[] args) {
        LeetcodeNodeSinglyLinkedListOfLeadingNodes<Integer> linked = new LeetcodeNodeSinglyLinkedListOfLeadingNodes<>(-1);
        linked.addFirst(1);
        linked.addFirst(2);
        linked.addFirst(3);
        linked.addFirst(4);
