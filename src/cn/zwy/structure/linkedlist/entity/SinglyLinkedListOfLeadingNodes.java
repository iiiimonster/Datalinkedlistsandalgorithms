...
/**
 * &#064;Description:  泛型带头节点单链表<BR/>
 * 1.泛型带头节点单链表链表，必须初始化链表传入链表头。<BR/>
 * 2.带头节点特点是删除和添加操作都是一致的<BR/>
 * 3.引入“哨兵”的情况<BR/>
 * “哨兵”节点不存储数据，<BR/>
 * 无论链表是否为空，<BR/>
 * head指针都会指向它，<BR/>
 * 作为链表的头结点始终存在。<BR/>
 * 这样，插入第一个节点和插入其他节点，<BR/>
 * 删除最后一个节点和删除其他节点都可以统一为相同的代码实现逻辑了。<BR/>
 * &#064;author:  zwy<BR/>
 * &#064;date:  2022年06月24日 9:45<BR/>
 */
